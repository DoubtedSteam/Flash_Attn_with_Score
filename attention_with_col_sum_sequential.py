...
def _fwd_kernel_with_col_sum_sequential(
    ...
    Uses sequential (forward-order) processing for all cases
    ...
    - Sequential processing: processes key blocks in order (0, 1, 2, ...)
    """
    ...
    # Round-Robin processing: use Round-Robin to reduce atomic contention
